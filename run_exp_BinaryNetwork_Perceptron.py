...
model = nets.BinaryNetwork(layer_sizes, activations=['Sigmoid','Softmax']) #['Sigmoid','Softmax']

optimizer = optimizers.PerceptronModel_GradientOptimizer(lr=params['lr'])
...
#model = nets.MLP.too(nets.MLP, model,device)
